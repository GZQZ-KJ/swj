...
export default class forgetPass extends Component {
  ...
  render() {
    let { myemail, password, rePassword, btnText, keyposition } = this.state
    var re = /^[a-zA-Z\d]+([-_\.][a-zA-Z\d]+)*@[a-zA-Z\d]+\.[a-zA-Z\d]{2,4}$/
    return (
      <>
          ...
          <View>
            ...
            </View>
            {
              !re.test(myemail) || password === '' || rePassword === '' ?
                ...
                :
                <TouchableHighlight onPress={this.enterGo} style={{ ...styles.loginGo, 
                  marginTop:keyposition.loginGo,
